...
#live Keras Visualization loss plot
...
def clear_and_display_figure(fig, sleep=0.01, clean=True):
    img_data = io.BytesIO()
...
class SimpleTrainingCurves(object):
    ...
    def add(self, train_loss, valid_loss, train_metric, valid_metric, clean=True):
        ...
        clear_and_display_figure(self.fig, 0.01, clean)
